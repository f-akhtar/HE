...
def generate_keys():
	...
	with open('C:/Users/Farhan Akhtar/Desktop/phe-main/keys.json', 'w') as file: 
...
def get_keys():
	...
	"""
	with open('C:/Users/Farhan Akhtar/Desktop/phe-main/keys.json', 'r') as file: 
		keys = json.load(file)
...
def get_encrypted_result():
    ...
    with open('C:/Users/Farhan Akhtar/Desktop/phe-main/result.json', 'r') as file: 
        data = json.load(file)
        return data
...
with open('C:/Users/Farhan Akhtar/Desktop/phe-main/data.json', 'w') as file: 
